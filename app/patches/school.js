...
me.connect({}, 'mongodb://localhost/ti', function(app) {
  ...
  return School.findOne({
    ...
    var actual, course, courses, found, match, stuff, subject, subjects, term, terms, _i, _j, _k, _len, _len1, _len2, _ref;
    if (err) {
        ...
        for (_j = 0, _len1 = subjects.length; _j < _len1; _j++) {
          ...
          for (_k = 0, _len2 = courses.length; _k < _len2; _k++) {
            ...
            if (found == null) {
              ...
              match = found.courses.find(function(item) {
                if (item.number === course.number) {
                  return true;
                }
                return false;
              });
