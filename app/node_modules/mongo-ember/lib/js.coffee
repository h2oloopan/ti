...
postProcess = (data) ->
	...
	data = data.replace '\'{{url_power}}\'', '\'' + me.settings.authPath + '/power' + '\''
...
js = module.exports = 
	...
	bind: (app) ->
		thiz = @
		#generate static js for nginx as well
		...
		, (err, data) ->
			if err
				...
				#write it to file
				fs.writeFile me.settings.meOutputPath, thiz.js, (err) ->
					if err
						console.log err
					else
						console.log 'client-side me.js generated'

		app.get me.settings.mePath, (req, res) ->
			if !thiz.js?
				res.send 500, 'Something was wrong generating client me.js'
			else
				res.set 'Content-Type', 'text/javascript'
				res.send 200, thiz.js
