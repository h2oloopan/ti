...
crud = function(app, url, name) {
  var afterFunctions, apiFunctions, authFunctions, beforeFunctions, cname, dummyAuthFunction, dummyFinalFunction, finalFunctions, model, names, pf;
    ...
    return af(req, obj, req.user, power, function(err) {
      if (err) {
        ...
        if (apiFunctions.c != null) {
          return apiFunctions.c(req, res, model, obj, names);
        } else {
          obj = new model(obj);
                    ...
                    if (afterFunctions.c != null) {
                      return afterFunctions.c(result, req.user, function(err, result) {
                        if (err) {
                          ...
                          return final(h.wrap(result, name), function(err, data) {
                            if (err) {
                              return res.send(500, err.message);
                            } else {
    ...
    return af(req, null, req.user, power, function(err) {
      if (err) {
        ...
        if (apiFunctions.ra != null) {
          return apiFunctions.ra(req, res, model, null, names);
        } else {
                  ...
                  if (afterFunctions.ra != null) {
                    return afterFunctions.ra(result, req.user, function(err, result) {
                      if (err) {
                        ...
                        return final(h.wrap(result, cname), function(err, data) {
                          if (err) {
                            return res.send(500, err.message);
                          } else {
        ...
        if (apiFunctions.ro != null) {
          return apiFunctions.ro(req, res, model, {
            ...
            if (err) {
              ...
              return final(h.wrap(result.data, name), function(err, data) {
                if (err) {
                  return res.send(500, err.message);
                } else {
