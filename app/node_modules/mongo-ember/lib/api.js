...
crud = function(app, url, name) {
  var apiFunctions, authFunctions, cname, dummyAuthFunction, model, pf;
    ...
    return af(req.user, power, function(err) {
      ...
      if (err) {
        ...
        if (apiFunctions.c != null) {
          return apiFunctions.c(req, res, model);
        }
    ...
    return af(req, req.user, power, function(err) {
      if (err) {
        ...
        if (apiFunctions.ra != null) {
          return apiFunctions.ra(req, res, model);
        }
    ...
    return af(req, req.user, power, function(err) {
      ...
      if (err) {
        ...
        if (apiFunctions.u != null) {
          return apiFunctions.u(req, res, model);
        }
        id = req.params.id;
        obj = h.unwrap(req.body);
