      ...
      if (err) {
        ...
        if (apiFunctions.c != null) {
          ...
          if (manipulateFunctions.c != null) {
            return manipulateFunctions.c(obj, function(err, obj) {
              if (err) {
                return res.send(500, err.message);
              } else {
        ...
        if (apiFunctions.ra != null) {
          ...
          return model.find({}, function(err, result) {
            if (err) {
              ...
              return manipulateFunctions.ra(result, function(err, result) {
                if (err) {
                  return res.send(500, err.message);
                } else {
        ...
        if (apiFunctions.ro != null) {
          ...
          return model.findById(id, function(err, result) {
            if (err) {
              ...
              return manipulateFunctions.ro(result, function(err, result) {
                if (err) {
                  return res.send(500, err.message);
                } else {
      ...
      if (err) {
        ...
        if (apiFunctions.u != null) {
          ...
          if (manipulateFunctions.u != null) {
            return manipulateFunctions.u(obj, function(err, obj) {
              if (err) {
                return res.send(500, err.message);
              } else {
          ...
          return model.findById(id, function(err, result) {
            if (err) {
              ...
              if (manipulateFunctions.d != null) {
                return manipulateFunctions.d(result, function(err, result) {
                  if (err) {
                    return res.send(500, err.message);
                  } else {
