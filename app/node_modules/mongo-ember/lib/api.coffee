			...
			if err
				...
				if apiFunctions.c?
					...
					if manipulateFunctions.c?
						manipulateFunctions.c obj, (err, obj) ->
							if err
								res.send 500, err.message
							else
								obj.save (err, result) ->
				...
				if apiFunctions.ra?
					...
					model.find {}, (err, result) ->
						if err
							...
							manipulateFunctions.ra result, (err, result) ->
								if err
									res.send 500, err.message
								else
				...
				if apiFunctions.ro?
					...
					model.findById id, (err, result) ->
						if err
							...
							manipulateFunctions.ro result, (err, result) ->
								if err
									res.send 500, err.message
								else
			...
			if err
				...
				if apiFunctions.u?
					...
					if manipulateFunctions.u?
						manipulateFunctions.u obj, (err, obj) ->
							if err
								res.send 500, err.message
							else
					...
					model.findById id, (err, result) ->
						if err
							...
							if manipulateFunctions.d?
								manipulateFunctions.d result, (err, result) ->
									if err
										res.send 500, err.message
									else
