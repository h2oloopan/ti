							...
							if err
								...
								obj.save (err, result) ->
									if err
										...
										if afterFunctions.c? then afterFunctions.c result, req.user
						...
						if err
							...
							beforeFunctions.ra result, req.user, (err, result) ->
								if err
									...
									if afterFunctions.ra? then afterFunctions.ra result, req.user
						...
						if err
							...
							beforeFunctions.ro result, req.user, (err, result) ->
								if err
									...
									if afterFunctions.ro? then afterFunctions.ro result, req.user
							...
							if err
								...
								model.findByIdAndUpdate id, obj, (err, result) ->
									if err
										...
										if afterFunctions.u? then afterFunctions.u result, req.user
										res.send 200, h.wrap result, name
					else
						model.findByIdAndUpdate id, obj, (err, result) ->
							if err
									...
									if err
										...
										result.remove (err, result) ->
											if err
												...
												if afterFunctions.d? then afterFunctions.d result, req.user
												res.send 204
