...
var api, auth, fs, js, me, mongo, mongoose, path, requirements, settings;
...
me = module.exports = {
    ...
    load = function(dir) {
      ...
      for (_i = 0, _len = files.length; _i < _len; _i++) {
        ...
        _results.push((function(file) {
          var name, obj, requirement, schema, validationMessages;
          ...
          if (!fs.statSync(file).isDirectory()) {
            if (path.extname(file) === settings.modelExtension) {
              ...
              return requirements[name] = requirement;
            }
          } else {
            return load(file);
          }
  ...
  setup: function(options) {
    ...
    settings.defaultPower = options.defaultPower || 1;
