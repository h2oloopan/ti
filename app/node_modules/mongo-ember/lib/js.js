...
var createAdapter, createJs, createModel, createSerializer, js, me, toSend, toSkip;
...
createJs = function(name, schema) {
  ...
  console.log(name);
  console.log(schema);
  js = 'models["' + name + '"] = DS.Model.extend({' + createModel(schema) + '}); adapters["' + name + '"] = DS.RESTAdapter.extend({' + createSerializer(schema) + '}); serializers["' + name + '"] = DS.RESTSerializer.extend({' + createSerializer(schema) + '});';
  return js;
};
